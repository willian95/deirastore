...
class SaleController extends Controller
{
    ...
    function fetch(Request $request){
        try{
            ...
            $sales = Payment::with('user', 'guest', 'productPurchase', 'productPurchase.product', "user.location", "user.commune", "guest.location", "guest.commune")->has('productPurchase')->skip($skip)->take(10)->get();
