                        ...
                        <a href="{{ url('/brand/'.$brand->brand->slug) }}">
                            <div class="main-shop__item">
                                ...
                                <div class="main-shop__card">
                                    @foreach(App\Product::where('brand_id', $brand->brand_id)->whereNotNull("picture")->where("picture", "like", "https://cdn.cnetcontent.com")->orderBy('id', 'desc')->limit(3)->get() as $product)
