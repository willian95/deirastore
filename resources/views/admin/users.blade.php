    ...
    <div class="container content__admin">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h3 class="text-center">Usuarios Regsitrados</h3>
                        <table class="table">
                            <thead>
                                <tr>
                ...
                <div class="modal-body">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-4" v-if="userDetails != null && userDetails.business_name">
                                <p><strong>Razón social empresa</strong></p>
                                <p>@{{ userDetails.business_name }}</p>
                            </div>
                            <div class="col-4" v-if="userDetails != null && userDetails.business_rut">
                                <p><strong>RUT empresa</strong></p>
                                <p>@{{ userDetails.business_rut }}</p>
                            </div>
                            <div class="col-4" v-if="userDetails != null && userDetails.business_address">
                                <p><strong>Dirección empresa</strong></p>
                                <p>@{{ userDetails.business_address }}</p>
                            </div>
                            <div class="col-4" v-if="userDetails != null && userDetails.business_phone">
                                <p><strong>Teléfono empresa</strong></p>
                                <p>@{{ userDetails.business_phone }}</p>
                            </div>
                            <div class="col-4" v-if="userDetails != null && userDetails.business_mail">
                                <p><strong>Correo empresa</strong></p>
                                <p>@{{ userDetails.business_mail }}</p>
                            </div>
    ...
    <script>
        ...
        const app = new Vue({
            ...
            methods:{
                ...
                fetch(page = 1){
                    this.page = page
                    axios.get("{{ url('admin/users/registered/fetch/') }}"+"/"+page)
                    .then(res => {
