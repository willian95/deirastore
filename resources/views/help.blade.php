...
@section('content')
    ...
    <div class="container bg">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="text-center">¿Por qué comprar en Deira Store?</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <h2 class="text-center">Métodos y costos de envío</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <h2 class="text-center">Seguimiento de mi orden</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <h2 class="text-center">Cambios y devoluciones</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
